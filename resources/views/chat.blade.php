<x-app-layout >
    <div class="flex h-screen" x-data="chatComponent()">
        ...
        <div class="flex-1 flex flex-col bg-gray-100">
            ...
            <!-- Chat Messages -->
            <div class="flex-1 p-4 space-y-4 overflow-y-auto" id="chatWindow" x-ref="chatWindow" x-init="scrollToBottom()">
            ...
            <div class="bg-white pt-4 pb-2 px-4 shadow">
                <div class="flex space-x-2">
                    <textarea x-model="messageContent" id="chatInput" class="resize-none w-full p-2 bg-white border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 overflow-hidden" rows="1" placeholder="Type your message..."></textarea>
